...
function getTexVc(){
    return path.resolve(pipe.config.conf.texvc_path);
}
...
module.exports = function (getFolder, tex){
    return getFolder.then( function(folder) {
        ...
        var texvc = getTexVc();
        return file.exists(texvc)
            .then(function () {
                return spawn(texvc, args, {capture: ['stdout']}).then(function (result) {
